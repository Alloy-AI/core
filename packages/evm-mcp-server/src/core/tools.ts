              ...
              text: JSON.stringify(
                {
                  address,
                  message:
                    "This is the wallet that will be used for all transactions",
                },
                null,
                2,
              ),
    ...
    "get_allowance",
    {
      ...
      inputSchema: {
        ...
        ownerAddress: z
          .string()
          .optional()
          .describe("The owner address (defaults to the configured wallet)"),
        network: z
          .string()
          .optional()
          .describe("Network name or chain ID. Defaults to Ethereum mainnet."),
              ...
              text: JSON.stringify(
                {
                  ...
                  message:
                    "Transaction sent. Use get_transaction_receipt or wait_for_transaction to check confirmation.",
                },
                null,
                2,
              ),
              ...
              text: JSON.stringify(
                {
                  ...
                  txHash,
                  message:
                    "Transaction sent. Use get_transaction_receipt to check confirmation.",
                },
                null,
                2,
              ),
              ...
              text: JSON.stringify(
                {
                  ...
                  txHash,
                  message:
                    "Approval transaction sent. Use get_transaction_receipt to check confirmation.",
                },
                null,
                2,
              ),
