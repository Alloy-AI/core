import { PlusIcon, PuzzlePieceIcon, TagIcon } from "@phosphor-icons/react";
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage your published tools and knowledge bases.
            </p>
          </div>
                ...
                <div className="flex flex-col gap-4 h-full">
                  ...
                  <div className="pt-4 mt-auto border-t border-border flex justify-between items-center">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-7 text-xs text-primary hover:text-primary/80 hover:bg-primary/10 px-0"
                    >
                      Manage Item
                    </Button>
                  </div>
